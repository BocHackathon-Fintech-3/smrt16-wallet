...
public class HomeActivity extends BaseNavigationActivity implements View.OnClickListener, HomeCommsInterface, FragmentMessenger, Runnable, SignAuthenticationCallback
{
    ...
    private  NewSettingsFragment settingsFragment = new NewSettingsFragment();
    private DappBrowserFragment dappBrowserFragment  = new DappBrowserFragment();
    ...
    private  LifecycleObserver lifeCycle;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar();
        subId = PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getString("SUB_ID", "NA");
...
//    }
    ...
    {
        if(settingsFragment != null && walletFragment != null) {
            settingsFragment.backupSeedSuccess();
